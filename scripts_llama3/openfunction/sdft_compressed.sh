...
output_folder="predictions_llama31_instruct_awq_lora/${train_dataset}/${type}"
#result_file="results_llama3_instruct_awq_4bit/${train_dataset}/${type}.log"
result_file="results_llama31_instruct_awq_lora/seed.log"
#checkpoint_dir="checkpoints_llama3_instruct_awq_4bit/${train_dataset}/${type}"
checkpoint_dir="/home/hsin/AutoAWQ/Llama-3-8B-Instruct-AWQ-clean-lora-8-16"
tmp_predictions_dir="predictions_llama3_instruct_awq/${train_dataset}/${type}/distilled"
...
#     --output_dir llama3_instruct_awq
